/*
 * The imagetent reducer will always return an array of image's no matter what
 * You need to return something, so if there are no image's then just return an empty array
 * */
...
import BGCool from '../images/cool.gif';
