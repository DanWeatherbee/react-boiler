...
export default function () {
    return [
        ...
        },
        {
            ...
            text1: "This problem will most certainly extend beyond Mongoose to any library that attempts to load a binary file and Webpack, in its attempt to walk the dependency graph, tries to resolve this dependency.",
